...
class chitlm2ca_tests(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires(f"chitlm2ca/{self.chitlm2ca_version}")
    ...
    def test(self):
        if can_run(self):
            cmd = os.path.join(self.cpp.build.bindir, "chitlm2ca_tests")
